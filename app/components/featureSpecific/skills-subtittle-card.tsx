  ...
  return (
    <div className="p-5 rounded-xl bg-secondary border border-secondary-l flex flex-col gap-4">
      <div className="flex md:flex-row flex-col gap-3 justify-between items-center">
        <p className="w-full font-extrabold text-2xl md:text-2xl flex flex-col md:flex-row items-start md:items-center">
          Reflections <span className="hidden md:block">-</span>
          <span className="text-base font-light">ReactJS Development</span>
        </p>
        <div className="flex gap-3">
          ...
          <Button className="  text-white bg-white/20 ">
