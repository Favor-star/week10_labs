  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-secondary rounded-xl p-6 text-center space-y-4">
        ...
        <h2 className="text-2xl font-bold text-white">Vault Error</h2>
        <p className="text-white/70">
          We encountered an error while accessing your vault. This could be due
          to:
        </p>
        <ul className="text-white/60 text-sm space-y-1 text-left">
          <li>• Authentication issues</li>
          <li>• Invalid skill or resource ID</li>
