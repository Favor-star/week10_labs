    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-secondary rounded-xl p-6 text-center space-y-4">
        ...
        <p className="text-white/70">
          We couldn't find the skill you're looking for. This could be because:
        </p>
        <ul className="text-white/60 text-sm space-y-1 text-left">
          <li>• The skill doesn't exist</li>
          <li>• You don't have permission to access it</li>
          <li>• The skill has been deleted</li>
          <li>• Invalid skill ID provided</li>
        </ul>
